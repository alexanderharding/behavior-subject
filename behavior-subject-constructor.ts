...
export interface BehaviorSubjectConstructor {
  /**
   * Creates and returns an object that acts as a [`Subject`](https://jsr.io/@xan/subject/doc/~/Subject) that keeps track of it's current
   * value and replays it to [`consumers`](https://jsr.io/@xan/observer#consumer) upon
